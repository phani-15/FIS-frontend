...
import { Home, FileText, Bell, Shield, User, GraduationCap, Briefcase, Users, BookOpen, Save, X } from 'lucide-react';
...
const EditProfilePage = () => {
  ...
  const restoreItem = (section, index) => {
    setProfile(prev => {
    const updatedSection=[...prev[section]]
      const original = initialProfile[section][index];
      updatedSection[index]=original 
                ...
                <div key={index} className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 border border-gray-200 rounded-lg">
                  ...
                  <div className="flex items-end space-x-2">
                    ...
                    <button
                      ...
                      className="px-3 py-2 bg-purple-500 text-white rounded-lg hover:bg-purple-600 cursor-pointer transition-colors text-sm"
                    >
                    undo
                    </button>
                    <button
            ...
            <div className="space-y-3">
              {profile.adminServiceThis.map((service, index) => (
                <div key={index} className="flex items-center space-x-3 p-3 border border-gray-200 rounded-lg">
                  ...
                  <button
                    onClick={() => removeItem('adminServiceThis', index)}
                    className="px-3 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 cursor-pointer transition-colors text-sm"
                  >
                    Remove
                  </button>
            ...
            <div className="space-y-3">
              {profile.adminServiceOther.map((service, index) => (
                <div key={index} className="flex items-center space-x-3 p-3 border border-gray-200 rounded-lg">
                  ...
                  <button
                    onClick={() => removeItem('adminServiceOther', index)}
