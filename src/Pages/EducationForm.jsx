...
export default function EducationForm() {
  ...
  return (
    <div className="m-5 flex flex-col justify-center items-center">
      <div className="w-full max-w-6xl bg-white rounded-2xl shadow-xl p-8 text-center">
        <h1 className="text-2xl font-semibold mb-4">Education Details</h1>

        <form onSubmit={handleSubmit} className="flex justify-around flex-col" >
          <div className="p-10 flex  ">
            ...
            <div className="flex-1">
              {/* Inter / Diploma */}
              <h2 className="text-lg font-semibold mt-4">Intermediate / Diploma</h2>
              <div className="flex flex-col text-left space-y-2 mt-4">
          ...
          <div className="bg-gray-400 h-[0.5px] w-[42%] ml-10 "></div>
          <div className="bg-gray-400 h-[0.5px] w-[42%]"></div></div>
          <div className="p-10 flex justify-around">
            ...
            <div className="flex-1">
              {/* PG */}
              <h2 className="text-lg font-semibold ">Post Graduation (Optional)</h2>
              <div className="flex flex-col text-left space-y-2 mt-4">
